...
DietUnique = ggplot(dietunique, 
  ...
  geom_text(data = filter(dietunique, n == 2, nonsyn == "nonsyn"), aes(label = aavar, vjust = 2, hjust = 0.5)) +
  ggtitle("Number of samples containing each variant - diet specific") +
  facet_grid(STRAIN~diet) +
  ylab("Segment") +
...
DietUnique_Transmission = ggplot(filter(dietunique, n > 1, nonsyn != "syn"), 
                             aes(x = ntpos, 
                                 y = factor(segment, levels = c('H9N2_NS','H9N2_MP','H9N2_NA','H9N2_NP','H9N2_HA','H9N2_PA','H9N2_PB1','H9N2_PB2')))) +
