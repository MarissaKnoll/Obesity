...
```{r}
freq_dist = ggplot() +
  geom_density(aes(x = minorfreq, fill = diet), filter(vdf, inf_route == "Index"), binwidth = 0.025, alpha = 0.5) +
  #geom_density(aes(x = majorfreq, fill = diet), filter(con_change, inf_route == "Index"), binwidth = 0.025, alpha = 0.5) +
  PlotTheme1 +
  DietcolScale_fill
print(freq_dist)
