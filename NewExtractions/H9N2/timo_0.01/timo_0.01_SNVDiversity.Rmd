...
Setting up AF dataframes for bottleneck calculation
```{r}
...
files_dir = "~/Desktop/GitHub/Obesity/NewExtractions/H9N2/timo_0.01/freqfiles"
...
for(i in samples){
  ...
  write.table(df, file = glue("{files_dir}/Stock_{i}_freqs.csv"), row.names = FALSE, col.names = FALSE)
