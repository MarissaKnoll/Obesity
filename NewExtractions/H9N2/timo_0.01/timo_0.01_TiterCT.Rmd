...
avg_titer = ggplot(filter(m1,inf_route == "Index" | inf_route == "Contact"), 
  ...
  geom_jitter(size = 3, alpha = 0.2, aes(y = log10_titer)) +
...
```{r}
o_t = filter(m1,inf_route == "Index" & diet == "Obese" & segment == "H9N2_PB2" & DPI == "d10") 
# All 8 segments have the same info, just picked first segment
l_t = filter(m1,inf_route == "Index" & diet == "Lean" & segment == "H9N2_PB2" & DPI == "d10") 
# All 8 segments have the same info, just picked first segment

t.test(o_t$titer,l_t$titer)
# Significant comparisons at p < 0.05 with only good quality samples: Index - d08, Contact - none
# Significant comparisons at p < 0.05 with good and bad quality samples: Index - none, Contact - none
```
...
# Significant comparisons at p < 0.05 with only good quality samples: Index - d04 Contact: none
